...
public class SedanInterface {
    ...
    public static void addSedanIntheList(Scanner sc, Sedanlist sedanlist, Validation v) {
        ...
        System.out.print("\t" + " Enter the speed of the Sedan: ");
        ...
        System.out.print("\t" + " Enter the price of the Sedan: ");
        ...
        System.out.print("\t" + " Enter the mileage of the Sedan: ");
        ...
        System.out.print("\t" + " Enter the fuel type of the Sedan: ");
        ...
        System.out.print("\t" + " Enter the year of the Sedan: ");
        ...
        System.out.print("\t" + " Enter the manufacturer Discount of the Sedan: ");
